...
#include <jni.h>
/* Header for class suneido_language_jsdi_dll_DllFactory */

#ifndef _Included_suneido_language_jsdi_dll_DllFactory
#define _Included_suneido_language_jsdi_dll_DllFactory
#ifdef __cplusplus
extern "C" {
#endif
/*
