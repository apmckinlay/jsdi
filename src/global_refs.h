...
struct global_refs
{
    ...
    // [BEGIN:GENERATED CODE last updated Sun Jun 30 15:24:16 PDT 2013]
    private:
    ...
    public:
         ...
         */
    private:
        jclass suneido_language_jsdi_type_BasicType_;
    public:
        jclass suneido_language_jsdi_type_BasicType() const
        { return suneido_language_jsdi_type_BasicType_; }
        /**<
         * \brief Returns a global reference to the class <dfn>suneido.language.jsdi.type.BasicType</dfn>.
         * \return <dfn>suneido.language.jsdi.type.BasicType</dfn>
         *
         * Auto-generated by <dfn>suneido.language.jsdi.tools.GenerateGlobalReferences</dfn>.
         */
    // [END:GENERATED CODE]
     ...
     * global references. After initialization, the #ptr pointer may validly be
     * used to access global references.
     */
