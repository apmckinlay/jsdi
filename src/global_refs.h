...
struct global_refs
{
    ...
    public:
        ...
        /**<
         * \brief Returns a global reference to the instance method <code>public abstract int suneido.jsdi.type.Callback.invoke(suneido.SuValue,byte[])</code>.
         * \return <code>public abstract int suneido.jsdi.type.Callback.invoke(suneido.SuValue,byte[])</code>
    ...
    public:
        ...
        /**<
         * \brief Returns a global reference to the instance method <code>public abstract int suneido.jsdi.type.Callback.invokeVariableIndirect(suneido.SuValue,byte[],java.lang.Object[])</code>.
         * \return <code>public abstract int suneido.jsdi.type.Callback.invokeVariableIndirect(suneido.SuValue,byte[],java.lang.Object[])</code>
         * \see jclass suneido_jsdi_type_Callback() const
         *
         * Auto-generated by <code>suneido.jsdi.tools.GenerateGlobalReferences</code>.
         */
